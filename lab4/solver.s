...
0000000000000368 <.note.gnu.build-id>:
 ...
 377:	00 a9 d0 0f cb 5c    	add    BYTE PTR [rcx+0x5ccb0fd0],ch
 37d:	d3 bb ba b0 17 b8    	sar    DWORD PTR [rbx-0x47e84f46],cl
 383:	f9                   	stc    
 384:	86 65 9a             	xchg   BYTE PTR [rbp-0x66],ah
 387:	02 1f                	add    bl,BYTE PTR [rdi]
 389:	22 63 8d             	and    ah,BYTE PTR [rbx-0x73]
...
0000000000001070 <_start>:
    ...
    1088:	48 8d 3d 3a 01 00 00 	lea    rdi,[rip+0x13a]        # 11c9 <main>
...
0000000000001159 <solver>:
    ...
    1178:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    117c:	48 8b 00             	mov    rax,QWORD PTR [rax]
    117f:	48 8d 48 20          	lea    rcx,[rax+0x20]
    1183:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1187:	48 8b 00             	mov    rax,QWORD PTR [rax]
    118a:	48 8d 50 20          	lea    rdx,[rax+0x20]
    118e:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1192:	48 8b 00             	mov    rax,QWORD PTR [rax]
    1195:	48 83 c0 28          	add    rax,0x28
    1199:	4c 8b 45 d8          	mov    r8,QWORD PTR [rbp-0x28]
    ...
    11af:	41 ff d0             	call   r8
    11b2:	90                   	nop
    11b3:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
    11b7:	64 48 2b 04 25 28 00 	sub    rax,QWORD PTR fs:0x28
    11be:	00 00 
    11c0:	74 05                	je     11c7 <solver+0x6e>
    11c2:	e8 99 fe ff ff       	call   1060 <__stack_chk_fail@plt>
    11c7:	c9                   	leave  
    11c8:	c3                   	ret    
...
00000000000011c9 <main>:
    ...
    11e4:	48 b8 2a 2a 20 6d 61 	movabs rax,0x206e69616d202a2a
    11eb:	69 6e 20 
    11ee:	48 ba 3d 20 25 70 0a 	movabs rdx,0xa7025203d
    11f5:	00 00 00 
    11f8:	48 89 45 e0          	mov    QWORD PTR [rbp-0x20],rax
    11fc:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx
    1200:	48 8d 45 e0          	lea    rax,[rbp-0x20]
    1204:	48 8d 15 be ff ff ff 	lea    rdx,[rip+0xffffffffffffffbe]        # 11c9 <main>
    120b:	48 89 d6             	mov    rsi,rdx
    120e:	48 89 c7             	mov    rdi,rax
    1211:	b8 00 00 00 00       	mov    eax,0x0
    1216:	e8 25 fe ff ff       	call   1040 <printf@plt>
    121b:	48 8b 05 be 2d 00 00 	mov    rax,QWORD PTR [rip+0x2dbe]        # 3fe0 <printf@GLIBC_2.2.5>
    1222:	48 89 c7             	mov    rdi,rax
    1225:	e8 2f ff ff ff       	call   1159 <solver>
    122a:	b8 00 00 00 00       	mov    eax,0x0
    122f:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    1233:	64 48 2b 14 25 28 00 	sub    rdx,QWORD PTR fs:0x28
    123a:	00 00 
    123c:	74 05                	je     1243 <main+0x7a>
    123e:	e8 1d fe ff ff       	call   1060 <__stack_chk_fail@plt>
    1243:	c9                   	leave  
    1244:	c3                   	ret    
...
0000000000002000 <_IO_stdin_used>:
    ...
    2004:	25 6c 78 20 25       	and    eax,0x2520786c
    2009:	6c                   	ins    BYTE PTR es:[rdi],dx
    200a:	78 20                	js     202c <__GNU_EH_FRAME_HDR+0x18>
    200c:	25 6c 78 0a 00       	and    eax,0xa786c
...
0000000000002014 <__GNU_EH_FRAME_HDR>:
    ...
    2018:	38 00                	cmp    BYTE PTR [rax],al
    201a:	00 00                	add    BYTE PTR [rax],al
    201c:	06                   	(bad)  
    201d:	00 00                	add    BYTE PTR [rax],al
    201f:	00 0c f0             	add    BYTE PTR [rax+rsi*8],cl
    2022:	ff                   	(bad)  
    2023:	ff 6c 00 00          	jmp    FWORD PTR [rax+rax*1+0x0]
    2027:	00 2c f0             	add    BYTE PTR [rax+rsi*8],ch
    202a:	ff                   	(bad)  
    202b:	ff 94 00 00 00 4c f0 	call   QWORD PTR [rax+rax*1-0xfb40000]
    2032:	ff                   	(bad)  
    2033:	ff ac 00 00 00 5c f0 	jmp    FWORD PTR [rax+rax*1-0xfa40000]
    203a:	ff                   	(bad)  
    203b:	ff 54 00 00          	call   QWORD PTR [rax+rax*1+0x0]
    203f:	00 45 f1             	add    BYTE PTR [rbp-0xf],al
    2042:	ff                   	(bad)  
    2043:	ff c4                	inc    esp
    2045:	00 00                	add    BYTE PTR [rax],al
    2047:	00 b5 f1 ff ff e4    	add    BYTE PTR [rbp-0x1b00000f],dh
...
0000000000002050 <__FRAME_END__-0xc8>:
    ...
    20af:	00 90 ef ff ff 20    	add    BYTE PTR [rax+0x20ffffef],dl
	...
...
0000000000003dc0 <_DYNAMIC>:
    ...
    3de7:	00 48 12             	add    BYTE PTR [rax+0x12],cl
