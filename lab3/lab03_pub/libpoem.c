...
int init(){
	int i;
	long long int arr_num = sizeof(ndat)/sizeof(ndat[0]);
	long long address_list[arr_num][2];
	// read file
	...
	while(fgets(line, sizeof(line), f)){
		...
		p = strtok(NULL, d);
		// printf("%llx",p);
		address_list[num][0] = strtoll(value, &p, 16);
		p = strtok(NULL, d);
		address_list[num][1] = strtoll(value, &p, 16);
		p = strtok(NULL, d);
		
		printf("%llx %llx", address_list[0][0], address_list[0][1]);
	}
	// printf("s%d\n", ndat[0]);
	fclose(f);
	return 0; 
